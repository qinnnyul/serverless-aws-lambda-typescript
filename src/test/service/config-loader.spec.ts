...
describe('config loader for different environments', () => {
    it('should load conf for prod ', () => {
        ...
        mockContext = <Context>{
            ...
            invokedFunctionArn: 'arn:aws:lambda:us-east-1:669606450274:function:serverless-aws-lambda-demo-prod-s3-event-proccessor',
            memoryLimitInMB: 128,
            awsRequestId: 'mock',
            logGroupName: 'mock',
            logStreamName: 'mock'
    ...
    it('should load conf for dev ', () => {
        ...
        mockContext = <Context>{
            ...
            functionName: 'mock',
            functionVersion: 'version',
            invokedFunctionArn: 'arn:aws:lambda:us-east-1:669606450274:function:serverless-aws-lambda-demo-dev-s3-event-proccessor',
            memoryLimitInMB: 128,
            awsRequestId: 'mock',
            logGroupName: 'mock',
            logStreamName: 'mock'
